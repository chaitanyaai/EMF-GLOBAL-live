...
<html lang="en">
  ...
  <body>
    <div class="container">
      <img class="logo" src="https://www.gstatic.com/aistudio/ai_studio_favicon_2_256x256.png" alt="AI Studio Logo" width="256" height="256" />
      <div class="spinner">
      </div>
      <div id="error-ui" class="hidden">
        <div class="icon">
          <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48px" height="48px" fill="#D73A49">
            <path d="M12,2C6.486,2,2,6.486,2,12s4.486,10,10,10s10-4.486,10-10S17.514,2,12,2z M13,17h-2v-2h2V17z M13,13h-2V7h2V13z">
            </path>
          </svg>
        </div>
        <div id="stepOne" class="text-container">
          ...
          <div class="button-container">
            <button id="authInSeparateWindowButton" onclick="redirectToReturnUrl(true)">
        ...
        <div id="stepTwo" class="text-container hidden">
          ...
          <div class="button-container">
            <button id="interactButton" onclick="redirectToReturnUrl(false)">
              Close and continue
            </button>
          </div>
        </div>
        <div id="stepThree" class="text-container hidden">
          ...
          <div class="button-container">
            <button id="grantPermissionButton" onclick="grantStorageAccess()">
              Grant permission
            </button>
          </div>
        </div>
    ...
    <script>
      ...
      async function redirectToReturnUrl(autoClose) {
        ...
        if (autoClose) {
          ...
          finalUrl.searchParams.set(&#39;__auto_close&#39;, &#39;1&#39;);
          const url = new URL(window.location.href);
          url.searchParams.set(&#39;return_url&#39;, finalUrl.toString());
